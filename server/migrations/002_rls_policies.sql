...
DROP POLICY IF EXISTS "Students see own registrations" ON public.registrations;
...
DROP POLICY IF EXISTS "Admins have full registration access" ON public.registrations;
...
DROP POLICY IF EXISTS "Admins have full team access" ON public.teams;
...
DROP POLICY IF EXISTS "Admins have full team_members access" ON public.team_members;
...
DROP POLICY IF EXISTS "Authenticated users can read active codes" ON public.attendance_codes;
...
DROP POLICY IF EXISTS "Admins have full attendance access" ON public.attendance;
...
DROP POLICY IF EXISTS "Students see own certificates" ON public.certificates;
CREATE POLICY "Students see own certificates"
  ON public.certificates FOR SELECT
  USING (student_id = auth.uid());

DROP POLICY IF EXISTS "Admins have full certificate access" ON public.certificates;
...
DROP POLICY IF EXISTS "Admins have full feedback access" ON public.feedback;
...
DROP POLICY IF EXISTS "Service role inserts admin_logs" ON public.admin_logs;
