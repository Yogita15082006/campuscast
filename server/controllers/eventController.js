...
exports.createEvent = async (req, res) => {
  try {
    const eventData = {
      ...
      total_seats: parseInt(req.body.capacity || req.body.totalSeats || req.body.total_seats || 100),
      remaining_seats: parseInt(req.body.capacity || req.body.totalSeats || req.body.total_seats || 100),
...
exports.updateEvent = async (req, res) => {
  try {
    const updateData = {
      ...
      venue: req.body.venue,
      total_seats: req.body.capacity || req.body.totalSeats ? parseInt(req.body.capacity || req.body.totalSeats) : undefined,
